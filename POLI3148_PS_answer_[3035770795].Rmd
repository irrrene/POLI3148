...
ggplot(d_tally_state, aes(x = reorder(state, n_fraud), y = n_fraud, fill = d_tally_state$prop_fraud)) +
...
```{r, echo=TRUE}
ggplot(d, aes(x = salinas_prop, fill = fraud_bin, linetype = fraud_bin)) +
...
ggplot(d, aes(x = cardenas_prop, fill = fraud_bin, linetype = fraud_bin)) +
    geom_density(alpha = 0.6, color = "white") + 
  scale_fill_manual(values = c("skyblue","orange")) + 
  ggtitle("Cardenas (FDN)") + 
  theme(plot.title.position = "plot") +
  xlab("Vote Share")

ggplot(d, aes(x = clouthier_prop, fill = fraud_bin, linetype = fraud_bin)) +
    geom_density(alpha = 0.6, color = "white") + 
  scale_fill_manual(values = c("skyblue","orange")) + 
  ggtitle("Clouthier (PAN)") + 
  theme(plot.title.position = "plot") +
  xlab("Vote Share")
